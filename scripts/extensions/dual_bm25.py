...
# Robust imports across Crawl4AI versions
try:
    from crawl4ai.deep_crawling.filters import URLFilter
except Exception:  # pragma: no cover
    from crawl4ai.deep_crawling.filters import BaseURLFilter as URLFilter  # type: ignore

try:
    from crawl4ai.deep_crawling.scorers import URLScorer
except Exception:  # pragma: no cover
    from crawl4ai.deep_crawling.scorers import BaseURLScorer as URLScorer  # type: ignore

try:
    from crawl4ai.utils import HeadPeekr
except Exception:  # pragma: no cover
    from crawl4ai.utils.head_peekr import HeadPeekr  # type: ignore
